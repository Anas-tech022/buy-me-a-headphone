...
const Login = () => {
    ...
    //     setLoginMessage(`Sorry, we only have GitHub available for login.`);
    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-[#07070a] text-white">
            ...
            <div className="absolute left-[-150px] top-[-150px] h-[450px] w-[450px] rounded-full bg-violet-600/20 blur-[130px] animate-pulse" />

            <div className="absolute bottom-[-200px] right-[-100px] h-[500px] w-[500px] rounded-full bg-fuchsia-600/10 blur-[140px]" />

            <div className="pointer-events-none absolute inset-0 opacity-[0.03] [background-image:linear-gradient(rgba(255,255,255,.8)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.8)_1px,transparent_1px)] [background-size:60px_60px]" />
            ...
            <div className="relative mx-auto flex min-h-screen max-w-7xl items-center justify-center px-5 py-10 sm:px-8">
                ...
                <div className="grid w-full max-w-6xl items-center gap-14 lg:grid-cols-2">
                    ...
                    <div className="hidden lg:block">
                        ...
                        <Link
                            href="/"
                            className="mb-12 inline-flex items-center gap-2 text-sm text-gray-500 transition hover:text-white"
                        >
                            <ArrowLeft size={16} />
                            Back to home
                        </Link>
                        ...
                        <div className="relative">
                            ...
                            {/* Glow */}
                            <div className="absolute left-20 top-20 h-64 w-64 rounded-full bg-violet-600/20 blur-[100px]" />

                            {/* Headphone */}
                            <div className="relative mx-auto h-[350px] w-[350px] animate-[float_5s_ease-in-out_infinite]">

                                {/* Headband */}
                                <div className="absolute left-1/2 top-5 h-[270px] w-[270px] -translate-x-1/2 rounded-t-full border-[20px] border-white/90 border-b-0 shadow-[0_0_70px_rgba(139,92,246,.25)]" />

                                {/* Left ear */}
                                <div className="absolute bottom-8 left-1 h-36 w-24 rotate-[-7deg] rounded-[32px] border border-white/20 bg-gradient-to-br from-[#292532] to-[#101015] shadow-2xl">

                                    <div className="absolute inset-4 rounded-[22px] bg-violet-500/10" />
                                ...
                                {/* Right ear */}
                                <div className="absolute bottom-8 right-1 h-36 w-24 rotate-[7deg] rounded-[32px] border border-white/20 bg-gradient-to-br from-[#292532] to-[#101015] shadow-2xl">
                            ...
                            {/* Floating card */}
                            <div className="absolute bottom-2 left-0 rounded-2xl border border-white/10 bg-[#111116]/80 p-4 backdrop-blur-xl">
                        ...
                        <div className="mt-10 max-w-lg">
                            ...
                            <p className="mt-5 leading-8 text-gray-500">
                                Sign in to continue supporting projects, discovering new
                                ideas, and being part of the development journey.
                            </p>
                    ...
                    <div className="w-full max-w-md justify-self-center">
                        ...
                        <div className="relative overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.035] p-6 shadow-2xl shadow-black/40 backdrop-blur-2xl sm:p-8">

                            {/* Card glow */}
                            <div className="absolute right-[-100px] top-[-100px] h-52 w-52 rounded-full bg-violet-600/10 blur-[80px]" />


                            <div className=' flex justify-center Text font-bold p-2 text-2xl m-2.5'>Login to Support Me</div>

                            <div className='btn justify-center items-center flex flex-col gap-2'>
                                <button onClick={() => { signIn("github") }}
                                    className="flex items-center w-2xs  bg-white border border-gray-300  shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 justify-center rounded-2xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                    <svg className="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                ...
                                <button  className="flex items-center justify-center bg-white border border-gray-300 rounded-2xl shadow-md max-w-xs w-2xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                    <svg className="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                ...
                                <div className=' flex text-lg font-wieght:400 pt-1.5'>Sorry, we only have GitHub available for login.</div>
